...
@Component({
    ...
    imports: [CommonModule,RouterModule,CollapseHeaderComponent,RouterLink,BreadcrumbsComponent,BsDatepickerModule,FormsModule,MatSortModule,CustomPaginationComponent]
})
