...
@Component({
    ...
    imports : [CommonModule,RouterModule,NgApexchartsModule,MatSelectModule,BsDatepickerModule,FormsModule,MatSortModule,BreadcrumbsComponent,CollapseHeaderComponent,RouterLink]
})
