...
@Component({
    ...
    imports: [CommonModule,RouterModule,BsDatepickerModule,FormsModule,BreadcrumbsComponent,
      CollapseHeaderComponent,CustomPaginationComponent,MatSortModule,AttendanceModalComponent]
})
