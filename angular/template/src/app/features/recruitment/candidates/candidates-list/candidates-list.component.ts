...
@Component({
    ...
    imports : [BreadcrumbsComponent,CollapseHeaderComponent,RouterModule,
      DateRangePickerComponent,MatInputModule,FormsModule,
      CustomPaginationComponent,MatSelectModule,MatSortModule,CommonModule]
})
