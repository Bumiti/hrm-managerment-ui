...
import { BreadcrumbsComponent } from '../../../common/breadcrumbs/breadcrumbs.component';import { BsDatepickerModule } from 'ngx-bootstrap/datepicker';
;
...
@Component({
    ...
    imports: [CommonModule,CustomPaginationComponent,
      MatSortModule,FormsModule,CollapseHeaderComponent,BreadcrumbsComponent,
      BsDatepickerModule
    ]
})
