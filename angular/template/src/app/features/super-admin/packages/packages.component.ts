...
@Component({
    ...
    imports: [CommonModule,CustomPaginationComponent,FormsModule,
      MatSortModule,DateRangePickerComponent,NgApexchartsModule,
      CollapseHeaderComponent,BreadcrumbsComponent,MatSelectModule,RouterLink
    ]
})
